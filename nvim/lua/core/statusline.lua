...
local function get_filepath()
  ...
  if vim.fn.winwidth(0) * 0.4 < #filepath then
...
Statusline.active = function()
  return table.concat({
    ...
    highlight("StatuslineSymbolOff", "󰀻 "),
    highlight("StatuslineMode", "(OㅈO=マ"),
    highlight("StatuslineSymbolOff", "󰀻 "),
  })
end
...
vim.api.nvim_set_hl(0, "StatuslineSymbolOff", { fg = "#075046", bg = "#000000" })
vim.api.nvim_set_hl(0, "StatuslineSymbolOn", { fg = "#0A6F61", bg = "#000000" })
vim.api.nvim_set_hl(0, "StatuslineMode", { fg = "#50E4B8", bg = "#000000" })
